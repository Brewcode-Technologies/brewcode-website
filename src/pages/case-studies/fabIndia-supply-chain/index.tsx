...
const challengesData = [
  {
    ...
    description:
      "Maintaining optimal inventory levels across multiple stores and warehouses to avoid shortages and excess stock.",
  },

  {
    ...
    description:
      "Managing the demand fluctuations for seasonal products and regional preferences.",
  },
  {
    id: 3,
    title: "Logistical Inefficiencies",
    description:
      "High logistics costs and delays due to suboptimal transportation routes and lack of real-time tracking.",
  },

  {
    ...
    description:
      "Ensuring timely supply of raw materials from numerous small-scale artisans across India.",
  },
];
...
const ObjectivesData = [
  {
    ...
    description:
      "Decrease the time taken from raw material procurement to product delivery.",
  },
  {
    id: 2,
    goal: "Minimize Costs",
  ...
  },
  {
    ...
    description:
      "Improve coordination with numerous small-scale artisans and suppliers.",
  },
  {
    id: 5,
...
const data = [
  {
    ...
    description:
      "Reduced the time from raw material procurement to product delivery by 20%, ensuring timely availability of products in stores.",
  },
  {
    step: 2,
    title: "Cost Savings",
  ...
  },
  {
    ...
    description:
      "Improved demand forecasting accuracy by 25%, leading to more efficient production planning and reduced stockouts.",
  },
  {
    step: 4,
    title: "Supplier Collaboration",
    description:
      "Enhanced collaboration with small-scale artisans and suppliers, resulting in more consistent supply and better quality control.",
  },
  {
    step: 5,
    title: "Sustainability Goals",
    description:
      "Successfully integrated sustainable practices, reducing carbon emissions by 10% and improving FabIndia's environmental footprint.",
  },
];
...
const solutions = [
  {
    step: 1,
    title: "Advanced Analytics for Demand Forecasting",
    description: [
      "Implemented analytics tools to analyze historical sales data and market trends.",
  ...
  },
  {
    ...
    description: [
      "Deployed a modern WMS to improve inventory management and reduce holding costs.",
      "Implemented barcode scanning and RFID technology for real-time inventory tracking.",
    ],
  },
  {
    step: 3,
  ...
  },
  {
    ...
    description: [
      "Developed an online platform to improve communication with small-scale artisans and suppliers.",
      "Shared real-time data on production schedules and quality standards to ensure timely and consistent supply.",
    ],
  },
  {
    step: 5,
          ...
          <div className="row my-4 d-flex justify-content-between">
            <div className="col-md-6 col-md-4 mb-5">
              <div className="healthcare-text-container">
                <div className=" mb-5">
                  <h2 className="stroke-text text-white amul-heading">FabIndia’s Supply Chain Optimization in Partnership with Reliable Logistics India</h2>
                </div>
              </div>
            </div>
            ...
            <div className="col-12">
              <div className="about-content">
                ...
                <p className="text-center mb-5">
                  Amul and Efficient Logistics India faced several supply chain
                  challenges.
                </p>
              </div>
          ...
          <div className="soctor-about-section">
            <div className="col-12">
              <div className="about-content">
                ...
                <p className="text-center mb-5">
                  The collaboration aimed to achieve the following through
            ...
            <div className="col-12">
              <div className="about-content">
                ...
                <p className="text-center">
                  Through the partnership with Reliable Logistics India,
                  FabIndia achieved significant
                  <br />
          ...
          <div className="soctor-about-section">
            <div className="col-12">
              <div className="about-content">
                ...
                <p className="text-center">
                  FabIndia and Reliable Logistics India adopted several
