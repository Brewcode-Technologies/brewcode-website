...
export const metadata: Metadata = pageMetadata.caseStudies.main;
...
const Index: React.FC = () => {
  ...
  const getClassName = (size: 'small' | 'medium' | 'large'): string => {
    return size === 'small' ? 'small-logo' : size === 'medium' ? 'medium-logo' : 'large-logo';
  };
            ...
            <div className="row">
              <div className="hero-section-content">
                <div className="case-study-content">
                  <h1 className="case-study-heading mb-5 text-center">Case Studies</h1>
                  <p className="case-study-description">
                    Case studies are a great way to exhibit real-case scenarios and assist your
                    <br /> customers in accomplishing their goals. These are not just case studies
                    but tips on
                    <br /> how to use technology as a powerful asset in strengthening your business.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="case-studies-black-container container-fluid">
        <div className="container">
          {caseStudies.map((study) => (
            <CaseStudyCard key={study.id} study={study} getClassName={getClassName} />
          ))}
        </div>
      </div>
    </Layout>
