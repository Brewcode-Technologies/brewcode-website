        ...
        <div className="container">
          <div className="row">
            <div className="hero-section-content">
              <h1 className="cyber-security-services-heading mb-3">COOKIE POLICY</h1>

              <p className="insights-description text-center">Please read our cookie policy.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="dark-container py-5">
        <div className="container">
          <div className=" privacy-policy-container mb-5">
            ...
            <p className="privacy-policy-description"></p>
          </div>

          <div className="mb-4">
            <h5 className="privacy-notice-sub-heading">Last updated October 08, 2024</h5>
            <p className="privacy-notice-sub-heading-description">
              This Cookie Policy explains how __________ (" Company ", " we", " us", and " our")
              uses cookies and similar technologies to recognize you when you visit our websites at
              https://brewcode.co , (" Websites"). It explains what these technologies are and why
          ...
          <div className="mb-4">
            <h5 className="privacy-notice-sub-heading">What are cookies?</h5>
            <p className="privacy-notice-sub-heading-description">
            ...
            <p className="privacy-notice-sub-heading-description">
              Cookies set by the website owner (in this case, __________) are called "first party
          ...
          <div className="mb-4">
            <h5 className="privacy-notice-sub-heading">How can I control cookies?</h5>
            <p className="privacy-notice-sub-heading-description">
              ...
              amend your web browser controls to accept or refuse cookies. As the means by which you
              can refuse cookies through your web browser controls vary from browser-to-browser, you
            ...
            <p className="privacy-notice-sub-heading-description">
              ...
              http://www.aboutads.info/choices/ or http://www.youronlinechoices.com . The specific
              types of first and third party cookies served through our Websites and the purposes
          ...
          <div className="mb-4">
            <h5 className="privacy-notice-sub-heading mb-4">Essential website cookies:</h5>
          ...
          <div className="mb-4">
            <h5 className="privacy-notice-sub-heading">Do you serve targeted advertising? </h5>
            <p className="privacy-notice-sub-heading-description">
          ...
          <div className="mb-4">
            <h5 className="privacy-notice-sub-heading">Where can I get further information?</h5>
            <p className="privacy-notice-sub-heading-description">
              If you have any questions about our use of cookies or other technologies, please email
              us at contact@brewcode.co or by post to:
            </p>
            <p className="privacy-notice-sub-heading-description">
              Brewcode Technologies Private Limited
              <br />
