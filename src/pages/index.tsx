          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                description:
                  'Complete list of services, industries, case studies, and resources offered by Brewcode',
                itemListElement: [
                  {
                    '@type': 'ListItem',
                    position: 1,
                    item: {
                      ...
                      description:
                        'Learn about our mission, values, and team delivering innovative software solutions',
                      provider: {
                        '@type': 'Organization',
                        name: 'Brewcode Technology Private Limited',
                        sameAs: SITE_URL,
                  ...
                  },
                  {
                    ...
                    item: {
                      ...
                      description:
                        'Responsive, scalable, and secure websites tailored to your business needs',
                      provider: {
                        '@type': 'Organization',
                        name: 'Brewcode Technology Private Limited',
                        sameAs: SITE_URL,
                  ...
                  },
                  {
                    ...
                    item: {
                      ...
                      description:
                        'Comprehensive full-stack development covering frontend, backend, databases, and APIs',
                      provider: {
                        '@type': 'Organization',
                        name: 'Brewcode Technology Private Limited',
                        sameAs: SITE_URL,
                  ...
                  },
                  {
                    ...
                    item: {
                      ...
                      description:
                        'Immersive AR/VR experiences and custom augmented reality solutions',
                      provider: {
                        '@type': 'Organization',
                        name: 'Brewcode Technology Private Limited',
                        sameAs: SITE_URL,
                  ...
                  },
                  {
                    ...
                    item: {
                      ...
                      description:
                        'Scalable cloud infrastructure solutions including IaaS, PaaS, and SaaS',
                      provider: {
                        '@type': 'Organization',
                        name: 'Brewcode Technology Private Limited',
                        sameAs: SITE_URL,
                  ...
                  },
                  {
                    ...
                    item: {
                      ...
                      description:
                        'Comprehensive cybersecurity services with advanced threat detection',
                      provider: {
                        '@type': 'Organization',
                        name: 'Brewcode Technology Private Limited',
                        sameAs: SITE_URL,
                  ...
                  },
                  {
                    ...
                    item: {
                      ...
                      description:
                        'Digital healthcare solutions improving patient care and operational efficiency',
                      provider: {
                        '@type': 'Organization',
                        name: 'Brewcode Technology Private Limited',
                        sameAs: SITE_URL,
                  ...
                  },
                  {
                    ...
                    item: {
                      ...
                      description:
                        'Secure and compliant digital solutions for banking and financial institutions',
                      provider: {
                        '@type': 'Organization',
                        name: 'Brewcode Technology Private Limited',
                        sameAs: SITE_URL,
                  ...
                  },
                  {
                    ...
                    item: {
                      ...
                      description:
                        'Revolutionary healthcare application development providing personalized medical advice',
                      provider: {
                        '@type': 'Organization',
                        name: 'Brewcode Technology Private Limited',
                        sameAs: SITE_URL,
                  ...
                  },
                  {
                    ...
                    item: {
                      ...
                      description:
                        'How Brewcode helped AT&T develop innovative collaboration solutions',
                      provider: {
                        '@type': 'Organization',
                        name: 'Brewcode Technology Private Limited',
                        sameAs: SITE_URL,
                  ...
                  },
                  {
                    ...
                    item: {
                      ...
                      description:
                        'Latest technology trends, insights, and best practices from our expert team',
                      provider: {
                        '@type': 'Organization',
                        name: 'Brewcode Technology Private Limited',
                        sameAs: SITE_URL,
                  ...
                  },
                  {
                    ...
                    item: {
                      ...
                      description:
                        'Get in touch for software development, web design, and IT solutions needs',
                      provider: {
                        '@type': 'Organization',
                        name: 'Brewcode Technology Private Limited',
                        sameAs: SITE_URL,
