...
export const metadata: Metadata = pageMetadata.industries.healthcare;
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Industries', item: `${SITE_URL}/industries` },
        {
          ...
          position: 3,
          name: 'Healthcare',
          item: `${SITE_URL}/industries/healthcare`,
        },
      ],
    },
  ];
        ...
        <div className="container">
          <div className="row">
            <div className="hero-section-content">
              ...
              <p className=" services-description text-center">Home / Industries / Healthcare</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container">
          <div className="row" style={{ display: 'flex', justifyContent: 'space-between' }}>
            <div className="col-md-7">
              <div>
                <h2 className="industry-healthcare-sub-heading">IT Solutions for Healthcare</h2>
                <p className="industries-text">
                  Federal, state, EU, HIPAA, and Joint Commission regulations have conspired to
                  create a complex IT environment for the entire healthcare industry. Whether it is
                  a small community hospital or an entity that is part of a large healthcare
                  network, all organizations must continuously balance their mission of quality
                  patient care while meeting shifting compliance requirements. WEI provides the
                  technology and expertise to help you create an adaptive infrastructure to meet the
                  goals of patients, caregivers, and administrators.
                </p>
              </div>
              <div>
                ...
                <p className="industries-text">
                  As healthcare providers continue to receive incentives for implementing and
                  upgrading their EMR systems, these initiatives are increasing efficiency and
                  productivity. Meanwhile, risk with paper files is also being mitigated. WEI will
                  work with you to design, scale, and integrate the technology you need to fully
                  adopt efficient EMR strategies.
                </p>
              </div>
              <div>
                <h2 className="industry-healthcare-sub-heading">Regulation and Compliance</h2>
                <p className="industries-text">
                  Government and private payer standards have created a daunting task for IT
                  professionals. How can you stay innovative and efficient while remaining compliant
          ...
          <div className="row">
            {healthcare.map((blogItem) => (
              <div key={blogItem.id} className="col-12 col-sm-6 col-md-4 gap-5 mb-4">
                <div className="mt-5">
                  <Link href={blogItem.link} passHref target="_blank" className="blog-link">
                    <div className="insight-card-link">
                      <div className=" mb-3">
                        ...
                        <h3 className="health-insurence-card-heading px-1">{blogItem.heading}</h3>
            ...
            <div>
              <div className="d-flex">
                <img
                  ...
                  loading="lazy"
                />
                <h2 className="industry-healthcare-sub-heading mt-2">Security</h2>
              </div>
              <p className="industries-text">
                The ability to pull archived records for authorized caregivers improves clinical
                workflow, medical knowledge, and collaboration between departments. Policy-based
                rules for retention and deletion of patient information, images, research data, and
                files can decrease assets used and save budgetary funds. WEI offers hardware and
                software-based storage solutions to scale precisely to your specific needs.{' '}
              </p>
            </div>
          </div>
          <div className="row">
            <div>
              ...
              <p className="industries-text">
                Shortening the time to implement a new initiative in the business world means extra
                profit. In the world of healthcare, it’s a matter of life and death. Converged
                Infrastructure and Adaptive Infrastructure solutions can lower time to market, or in
                this case time to treatment, from weeks to just minutes. Using virtualized scalable
                servers in conjunction with virtualized storage, virtualized I/O, and intuitive
                management software, templates can be created to provision for new initiatives and
                allocate the resources needed in a matter of minutes.
              </p>
            </div>
          </div>
          <div className="row">
            <div>
              <div className="d-flex">
                <img
                  ...
                  loading="lazy"
                />
                <h2 className="industry-healthcare-sub-heading mt-2">Time to Treatment</h2>
              </div>
              ...
              <p className="industries-text">
                ...
                upgrading their EMR systems, these initiatives are increasing efficiency and
                productivity. Meanwhile, risk with paper files is also being mitigated. WEI will
                work with you to design, scale, and integrate the technology you need to fully adopt
                efficient EMR strategies.
              </p>
            </div>
          </div>
        </div>
