    ...
    <Layout>
      ...
      <div className="dark-container py-5">
        <div className="container">
          ...
          <h5 className="privacy-notice-heading">PRIVACY NOTICE</h5>
          <div className="mb-4">
            <h5 className="privacy-notice-sub-heading">
              Last updated june 08, 2024
            </h5>
            <p className="privacy-notice-sub-heading-description">
              This privacy notice for Brewcode Technologies Private Limited
            ...
            <ul className="privacy-notice-sub-heading-description">
              <li>
                Visit our website at https://brewcode .co, or any website of
          ...
          <div className="mb-4">
            ...
            <p className="privacy-notice-sub-heading-description">
              ...
              also click &nbsp;<a href="">here</a> to go directly to our table
              of contents.
            </p>
            <p className="privacy-notice-sub-heading-description">
              What personal information do we process? When you visit, use, or
              navigate our Services, we may process personal information
              depending on how you interact with Brewcode Technologies Private
            ...
            <p className="privacy-notice-sub-heading-description">
              Want to learn more about what Brewcode Technologies Private
              Limited does with any information we collect? Click here to review
              the notice in full.
            </p>
          </div>
          <div className="mb-4">
            <h5 className="privacy-notice-sub-heading">TABLE OF CONTENTS</h5>
            <div>
              <a
                href="https://codebeautify.org/htmlviewer#infocollect"
          ...
          <div className="mb-4">
            ...
            <h5 className="privacy-notice-sub-heading-first ">
          ...
          <div className="mb-4">
            ...
            <p className="privacy-notice-sub-heading-description">
              ...
              <a href="https://brewcode .co/cookie-policy">
                https://brewcode .co/cookie-policy.
              </a>
            </p>
          </div>
          <div className="mb-4">
          ...
          <div className="mb-4">
            ...
            <p className="privacy-notice-sub-heading-description">
              ...
              other non-marketing purposes. <br />
              ...
              see our Cookie Notice: https://brewcode .co/cookiepolicy. <br />
              If you have questions or comments about your privacy rights, you
              may email us at contact@brewcode.co.
            </p>
          </div>
