...
export const metadata: Metadata = pageMetadata.services.cyberSecurity;
        ...
        <div className="container">
          <div className="row">
            <div className="hero-section-content">
              <h1 className="cyber-security-services-heading mb-3">Cyber Security Services</h1>
        ...
        <div className="container">
          <div className="col-12">
            ...
            <p className="chart-of-detail mb-4">
              ...
              impact on business operations. Advanced persistent
              <br /> threats can quickly break out across your network, infecting your endpoints,
              moving laterally across your systems and disrupting your <br />
              business.
            </p>
          </div>
          <div className="row">
            <div className="cyber-security-the-challenge-card col-12 col-md-4 py-5 card-margin-right my-5">
              ...
              <p className="cyber-security-the-challenge-card-description">
                Sophisticated cyberattacks often establish multiple points of undetected persistence
                in your network in order to infect your systems with malware or steal sensitive data
            ...
            <div className="cyber-security-the-challenge-card col-12 col-md-4 py-5 card-margin-right my-5">
              ...
              <p className="cyber-security-the-challenge-card-description">
                The threat landscape continues to evolve, with stealthy, sophisticated attacks
                regularly evading the security technology and expertise of many organizations.
              </p>
            </div>
            <div className="cyber-security-the-challenge-card col-12 col-md-4 py-5 my-5">
              ...
              <p className="cyber-security-the-challenge-card-description">
                Traditional recovery methods from advanced persistent threats rely on reimaging and
                rebooting endpoints from backup images, which can disrupt the end users and cause
                business downtime.
              </p>
            </div>
          </div>
          <div className="row my-5">
            ...
            <div className="d-flex flex-column col-12 col-md-6">
              <div className="my-1">
                ...
                <p>
                  Within the first 24 hours of an engagement, the rapid deployment and configuration
                  of the platform begin, with powerful prevention policies to immediately stop the
                  execution and <span className="lateral-movement-underline">lateral movement</span>{' '}
                  of active attacks
                </p>
              </div>
              ...
              <div className="my-1">
                ...
                <p>
                  Over the next 72 to 96 hours, the Brewcode Services team leverages the Falcon
                  platform to analyze attacks and actively remediate and remove any memory-resident{' '}
                  <span className="lateral-movement-underline">malware</span> persistence and other
                  active attack components.
                </p>
              </div>
              <div className="my-1">
                <div className="d-flex">
                ...
                <p>
                  The OverWatch threat hunting team monitors for attack techniques designed to
                  bypass even the best security technology and communicates directly with the
                  recovery team when attacker behavior is observed and remediation is required
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="row d-flex justify-content-center">
            <div className="experienced-breach-image">
              ...
              <ReusableButton label="GET ASSISTANCE" navigateTo="/contact-us" />
            </div>
          </div>
        </div>
      </div>
