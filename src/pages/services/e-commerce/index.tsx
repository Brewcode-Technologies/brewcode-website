...
export const metadata: Metadata = pageMetadata.services.eCommerce;

type Technology = 'AR/VR' | 'Machine Learning' | 'Computer Learning' | 'Predictive Analytics';
  ...
  const ecommerceItems: EcommerceService[] = [
    {
      ...
      description: 'Tailored development of e-commerce websites to meet unique business needs.',
    },
    {
      title: 'E-Commerce Platform Integration Services',
      description: 'Seamless integration of e-commerce platforms with existing systems.',
    },
    {
    ...
    },
    {
      ...
      description: 'Advanced analytics solutions to drive business insights and growth.',
    },
    {
      title: 'E-Commerce Security Solutions',
      description: 'Robust security measures to protect e-commerce platforms and customer data.',
    },
    {
          ...
          <div className="container">
            <div className="row">
              <div className="hero-section-content">
                <h1 className="services-header mb-3 text-center">Looking For Experienced Team</h1>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-md-5">
              <div className="d-flex flex-column">
                <h2 className="our-e-commerce-services col-12 py-3">Our E-Commerce Services</h2>
                ...
                <div className="d-flex flex-column mt-5" key={index}>
                  ...
                  {openAccordionIndex === index && (
                    <div className="e-commerce-content">
                      <p className="e-commerce-description">{item.description}</p>
                    </div>
                  )}
                </div>
              ))}
          ...
          <div className="row my-5">
            ...
            <div className="col-md-7">
              <p className="e-commerce-description">
                We apply advanced technologies to help online businesses deliver superb customer
                experiences and get a competitive edge.
              </p>
            </div>
          </div>
          <div className="row">
          ...
          <div className="container stepperContainer">
            <div className="row my-5">
              ...
              <div className="col-12 col-md-6 col-lg-3 step mb-4">
                ...
                <div className="stepDescription">
                  Coding, front-end and back-end development, integration with other systems and
                  tools
                </div>
              </div>
              <div className="col-12 col-md-6 col-lg-3 step mb-4">
              ...
              <div className="col-12 col-md-6 col-lg-3 step mb-4">
                ...
                <div className="stepDescription">Deployment to production environment</div>
              </div>
              <div className="col-12 col-md-6 col-lg-3 step mb-4">
                <div className="stepHeader">
                ...
                <div className="stepDescription">Ongoing support and maintenance</div>
              </div>
            </div>
          </div>
        </div>
