  ...
  return (
    ...
    <div
      ...
      >
        ...
        <div className="container">
          <div className="row">
            <div className="services-content">
              ...
              Brewcode Technology Private Limited embodies the pinnacle of full-stack development<br/> merging innovative design with powerful backend systems to bring your digital<br/> aspirations to life.
              </p>
        ...
        <div className="container">
          <div className="row d-flex justify-content-between my-5">
            <div className="col-md-8">
              ...
              At Brewcode Technology Private Limited, we are dedicated to accelerating your business growth through comprehensive full-stack development services. Our expertise spans the entire development cycle, from sophisticated front-end design to robust back-end solutions. We ensure seamless integration with databases, servers, and APIs, while our DevOps practices streamline deployment and scalability. With a keen focus on version control systems, we maintain the highest standards of quality and innovation. Partner with us to transform your vision into reality with cutting-edge full-stack solutions.
              </p>
              <p className="overview-detail mb-5">
              We brewcode Technology Private Limited full-stack development company, we cover every aspect of full-stack development - front-end and back-end, databases, servers, APIs, DevOps, and version controlling systems. Set a faster pace for the growth of your business with our full-stack development services.
              </p>
            ...
            <div className="row d-flex  justify-content-between">
              <div className="col-lg-4 col-md-6 col-12 mb-4">
                <h3 className="our-section-heading mb-5">
                  Full Stack Development<br /> Services We Provide
                </h3>
              ...
              <div className="col-lg-7 col-md-6 col-12">
                <div className="row mb-4 d-flex  justify-content-between">
                  ...
                  <div className="d-flex flex-column justify-content-between">
                    ...
                    <div className="mb-3">
                      <h4 className="service-title ui-ux-heading mb-3">
                      Dedicated Full Stack Developers                      </h4>
                      <p className="service-description">
                      Our investments in innovative solutions ensure you benefit from the latest accelerators, methodologies and engagement models tailored to meet your evolving needs.
                      </p>
              ...
              <div className="row">
                <div className="col-lg-3 col-md-6 col-12 mb-4">
                  <div className="Services-card full-stack-card">
                    ...
                    <div className="card-body">
                      ...
                      We follow an agile development methodology to bring your idea to a fully functional product with a rich user experience at its core.                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-lg-3 col-md-6 col-12 mb-4">
                  <div className="Services-card full-stack-card">
                    ...
                    <div className="card-body">
                      ...
                      <p className="card-text">
                      We assign a project manager to manage tasks, oversee complex processes, and coordinate collaboration between team members and clients.                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-lg-3 col-md-6 col-12 mb-4">
                  <div className="Services-card full-stack-card">
                    ...
                    <div className="card-body">
                      <h5 className="card-title">
                      80% employee retention rate                      </h5>
                      <p className="card-text">
                      We pay special attention to employee retention because clients are interested in hiring full-stack developers for the long term.                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-lg-3 col-md-6 col-12 mb-4">
                  <div className="Services-card full-stack-card">
                    ...
                    <div className="card-body">
                      ...
                      High customer satisfaction rating                      </h5>
                      <p className="card-text framework">
                      Our full-stack development services deliver a high client retention rate with 100% customer satisfaction for every project.                      </p>
                    </div>
                  </div>
                </div>
                <div className="col-lg-3 col-md-6 col-12 mb-4">
                  <div className="Services-card full-stack-card">
                    ...
                    <div className="card-body">
                      <h5 className="card-title">
                      Experienced developers                      </h5>
                      <p className="card-text">
                      Our full-stack developers have proven expertise across all industry verticals, so you can count on them to perform numerous tasks.                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-lg-3 col-md-6 col-12 mb-4">
                  <div className="Services-card full-stack-card">
                    ...
                    <div className="card-body">
                      ...
                      Risk handling                      </h5>
                      <p className="card-text framework">
                      We are constantly improving our practices of risk management. It makes us not just a supplier of top-quality full-stack development services but a trustworthy partner.                      </p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="container">
        <h3 className="full-stack-section-heading text-center">Our suite of full-stack development services include</h3>
