        ...
        <div className="container">
          <div className="row">
            <div className="services-content">
              <h1 className="services-header">Terms</h1>
      ...
      <div className="dark-container py-5">
        <div className="container">
          <div className=" privacy-policy-container mb-5">
            ...
            Please read the terms & conditions of this website.
            </p>
          </div>
          ...
          <div className="mb-4">
            ...
            <p className="privacy-notice-sub-heading-description">
            These Terms of Use constitute a legally binding agreement made
              between you, whether personally or on behalf of an entity (“you”)
              and Brewcode Technologies Private Limited ("Company," “we," “us,"
              or “our”), concerning your access to and use of the
              https://brewcode .co/ website as well as any other media form,
              media channel, mobile website or mobile application related,
              linked, or otherwise connected thereto (collectively, the “Site”).
              We are registered in India and have our registered office at Plot
              No 27, Mahesh Nagar, Bidar, Karnataka 585401. You agree that by
           ...
           Supplemental terms and conditions or documents that may be posted
              ...
              would violate the Gramm-Leach-Bliley Act (GLBA).</p>
              <p className="privacy-notice-sub-heading-description">
              ...
              read and agree to these Terms of Use prior to you using the Site.</p>
          ...
          <div className="mb-4">
            <h5 className="privacy-notice-sub-heading">3. USER REPRESENTATIONS</h5>
            <p className="privacy-notice-sub-heading-description">
          ...
          <div className="mb-4">
            <h5 className="privacy-notice-sub-heading mb-4">
            ...
            <ul className="text-decoration-none">
                <li className="privacy-notice-sub-heading-description">
                ...
                <li className="privacy-notice-sub-heading-description">Web Development</li>
                <li className="privacy-notice-sub-heading-description">Full Stack Development</li>
                <li className="privacy-notice-sub-heading-description">Mobile Application Development</li>
              </ul>
          </div>
          <div className="mb-4">
            <h5 className="privacy-notice-sub-heading mb-3">
            ...
            The Site does not offer users to submit or post content. We may
              ...
              any manner contemplated by the Site and these Terms of Use.You
              ...
              Terms of Use.Your Contributions are not false, inaccurate, or
              ...
              minors.Your Contributions do not include any offensive comments
              ...
              regulation. Any use of the Site in violation of the foregoing
          ...
          <div className="mb-4">
            ...
            We care about data privacy and security. Please review our Privacy
              Policy: https://brewcode .co/privacy-policy. By using the Site,
              ...
              India. If you access the Site from any other region of the world
          ...
          <div className="mb-4">
            ...
            These Terms shall be governed by and defined following the laws of
              India. Brewcode Technologies Private Limited and yourself
          ...
          <div className="mb-4">
            ...
            <p className="privacy-notice-sub-heading-description">Informal Negotiations</p>
            <p className="privacy-notice-sub-heading-description">
            ...
            <p className="privacy-notice-sub-heading-description">Binding Arbitration</p>
            <p className="privacy-notice-sub-heading-description"> Any dispute arising out of or in connection with this contract,
              ...
              number of arbitrators shall be two (2). The seat, or legal place,
              of arbitration shall be Hyderabad, India. The language of the
              proceedings shall be English. The governing law of the contract
              shall be the substantive law of India.</p>
            <p className="privacy-notice-sub-heading-description">Restrictions</p>
            <p className="privacy-notice-sub-heading-description">  The Parties agree that the following Disputes are not subject to
